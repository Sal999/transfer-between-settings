...
Salar Mohammed
073-920 67 71
salar.mohammed@stud.ki.se

Supervisor: Martin Gerdin Wärnberg
Martin.gerdin@ki.se
+46708539598
How do transfers and updating of clinical prediction models for trauma triage affect mistriage rates?
...
Model development
Model development will be made through logistic regression using GCS, RR, SBP as independent variables and 30 days all cause mortality as a dependable variable. The development will made with a program called R Desktop. This process will be as described in the statistical methods with the model development taking place in the development sample in each dataset. It will be developed in a way that keeps over- and undertriage under a certain value and will give us a cut-off which will be a marker for major and minor traumas. 
...
Missing data
Missing data will be excluded from this study. 
